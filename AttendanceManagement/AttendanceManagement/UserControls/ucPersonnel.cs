...
namespace AttendanceManagement.UserControls
{
    public partial class ucPersonnel : UserControl
    {
        ...
        // 2. CLASS-LEVEL CONTROLS (Accessible from anywhere in the class)
        ...
        private void SetupLayout()
        {
            ...
            dgv.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "کد پرسنلی", DataPropertyName = "PersonelID" });
            dgv.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "نام و نام خانوادگی", DataPropertyName = "FullName" });
            dgv.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "بخش", DataPropertyName = "Department" });
            dgv.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "شیفت کاری", DataPropertyName = "ShiftID" });
